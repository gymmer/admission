...
window.console && console.warn("This version of Unslider is due to be deprecated by December 1. Please visit unslider.com for details on how to upgrade."), function (t, s) {
  if (!t) return s;var i = function i() {
    this.el = s, this.items = s, this.sizes = [], this.max = [0, 0], this.current = 0, this.interval = s, this.opts = { speed: 500, delay: 3e3, complete: s, keys: !s, dots: s, fluid: s };var i = this;this.init = function (s, i) {
      ...
      var e = t(this),
          n = e.outerWidth(),
          h = e.outerHeight();i.sizes[s] = [n, h], n > i.max[0] && (i.max[0] = n), h > i.max[1] && (i.max[1] = h);
    }, this.setup = function () {
      ...
      this.items.eq(s).length || (s = 0), 0 > s && (s = this.items.length - 1);var n = this.items.eq(s),
          h = { height: n.outerHeight() },
          o = e ? 5 : this.opts.speed;this.ul.is(":animated") || (i.el.find(".dot:eq(" + s + ")").addClass("active").siblings().removeClass("active"), this.el.animate(h, o) && this.ul.animate(t.extend({ left: "-" + s + "00%" }, h), o, function () {
      ...
      var e = s.which,
          n = { 37: i.prev, 39: i.next, 27: i.stop };t.isFunction(n[e]) && n[e]();
    }, this.next = function () {
      return i.stop().move(i.current + 1);
    }, this.prev = function () {
      return i.stop().move(i.current - 1);
    }, this.dots = function () {
      var s = '<ol class="dots">';t.each(this.items, function (t) {
    ...
    var e = this.length;return this.each(function (n) {
      var h = t(this),
          o = new i().init(h, s);h.data("unslider" + (e > 1 ? "-" + (n + 1) : ""), o);
    });
  };
}(window.jQuery, !1);